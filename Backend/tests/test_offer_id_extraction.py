...
class TestOfferIdExtraction:
    ...
    def real_airline_offer(self):
        ...
        # Get the airline offer from the OffersGroup structure
        return SAMPLE_VERTEIL_RESPONSE['OffersGroup']['AirlineOffers'][0]
    ...
    def test_offer_id_extraction_fallback_when_missing(self, real_priced_offer_without_offer_id, real_reference_data, real_airline_offer):
    ...
    def test_offer_id_extraction_fallback_when_empty(self, real_priced_offer_with_empty_offer_id, real_reference_data, real_airline_offer):
        ...
        with patch('utils.data_transformer.logger') as mock_logger, \
            ...
            # Verify logging shows fallback was used
            mock_logger.warning.assert_any_call(f"OfferID value not found, generated fallback ID: {result['id']}")
