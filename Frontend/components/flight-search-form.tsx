            ...
            <Button 
              ...
              disabled={
                ...
                (activeTab === 'multi-city' 
                  ? segments.some(s => !s.origin || !s.destination || !s.departureDate)
                  : !origin || !destination || !departDate || (activeTab === 'round-trip' && !returnDate)
                )
              }
            >
          ...
          <div className="space-y-4">
            ...
            <div className="mt-4 flex justify-center">
              <Button 
                className="px-8" 
                onClick={handleSearchButtonClick}
                disabled={loading || segments.some(s => !s.origin || !s.destination || !s.departureDate)}
              >
                {loading ? "Searching..." : "Search Flights"}
              </Button>
            </div>
