...
export function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-around items-center p-2 md:hidden z-50">
      ...
      <Link href="/bookings" className={cn(
        'flex flex-col items-center p-2 rounded-lg',
        isActive('/bookings') ? 'text-blue-600' : 'text-gray-600 hover:text-gray-900'
      )}>
